/**
 * Universal AI Agent Platform - JavaScript SDK
...
class UniversalAIClient {
     ...
     * @param {string} apiUrl - Base URL of the Universal AI Agent Platform API
    ...
    constructor(apiUrl = 'http://localhost:8000', apiKey = null) {
        ...
        this.headers = {
            ...
            'User-Agent': 'UniversalAI-JavaScript-SDK/1.0.0'
        };
...
class AgentSession {
     ...
     * @param {UniversalAIClient} client - UniversalAI client instance
 ...
 * @returns {Promise<AgentSession>} AgentSession instance
 */
async function createSimpleAgent(instructions, capabilities = ['text'], apiUrl = 'http://localhost:8000') {
    const client = new UniversalAIClient(apiUrl);
    const config = {
    ...
    return new AgentSession(client, sessionId);
}
